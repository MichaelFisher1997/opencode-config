...
## Scripting with Terminus (`05-scripting.md`)
...
- [Install Quicksilver Scripts](https://docs.pantheon.io/guides/quicksilver/install-script)
- [Cron for WordPress](https://docs.pantheon.io/guides/wordpress-developer/wordpress-cron)
- [Cron for Drupal](https://docs.pantheon.io/drupal-cron)
- [Continuous Integration Solutions on Pantheon](https://docs.pantheon.io/continuous-integration)
- [WordPress Composer Continuous Integration](https://docs.pantheon.io/guides/wordpress-composer/create-wp-site-composer-ci-auto-test#continuous-integration)
- [Build Tools Continuous Integration](https://docs.pantheon.io/guides/wordpress-composer/create-wp-site-composer-ci-auto-test#continuous-integration)
